...
--
ALTER TABLE pkgs DROP build;
ALTER TABLE builds ALTER id SET DATA TYPE VARCHAR(255);
ALTER TABLE pkgs ADD build VARCHAR(255) REFERENCES builds(id);
ALTER TABLE builds DROP runid;
